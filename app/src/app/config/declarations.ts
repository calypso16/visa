...
//CORE_REFERENCE_IMPORT-guesthousechecklistComponent
import { guesthousechecklistComponent } from '../components/guesthousechecklistComponent/guesthousechecklist.component';
...
//CORE_REFERENCE_PUSH_TO_DEC_ARRAY-guesthousechecklistComponent
guesthousechecklistComponent,
...
children: [{path: 'vehicle', component: vehiclechecklistComponent},{path: 'extension', component: visaextensionComponent},{path: 'guesthouse', component: guesthousechecklistComponent},{path: 'transport', component: transportrequestComponent}]},{path: 'login', component: loginComponent},{path: 'unauthorized', redirectTo: '/login', pathMatch: 'full'},{path: 'admin', component: adminComponent},{path: '', redirectTo: '/home', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
